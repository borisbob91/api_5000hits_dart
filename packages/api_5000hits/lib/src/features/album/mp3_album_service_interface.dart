...
abstract interface class Mp3AlbumServiceInterface {
  ...
  // Récupère le detail d'un album avec le slug.
  ...
  //retoune les autres albums de l'artist sant s l'album actuelle
  Future<List<Mp3Album>> getArtistAlbumBySlug({required String albumSlug});
  ...
  /// Récupère les albums similaires à un album donné.
  /// Combine les résultats locaux et distants pour une meilleure pertinence.
  Future<List<Mp3Album>> getTopDownloadAlbum({int page = 0, int pageSize = 20});
